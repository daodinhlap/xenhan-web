...
<c:choose>
	...
	<c:otherwise>
		<div class="form-group" id="user" style="margin-top: 10px">
			<div class="col-xs-4 col-md-4">Họ Tên</div>
			<div class="col-xs-8 col-md-8">
				<a href="#" id="name" data-type="text"
					data-url="/user/sua-thong-tin-nguoi-dung" data-name="name"
					data-pk="${user.user.phone}" data-original-title="Họ Tên"
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label ${user.userProfile.gender == 1 ? 'Nam' : 'Nữ'}></label>
			</div>
		</div>
		<!-- ADDRESS -->
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.address}</label>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-4 col-md-4">Tỉnh/Thành phố</div>
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.province}</label>
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-4 col-md-4">Quận/Huyện</div>
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.district}</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.placeOfBirth}</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label> <fmt:formatDate value="${user.userProfile.birthday}"
						pattern="dd-MM-yy" /></label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.identityCard}</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label> <fmt:formatDate
						value="${user.userProfile.dateOfIdentity}" pattern="dd-MM-yy" /></label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<label>${user.userProfile.facebookId}</label>
			</div>
		</div>
