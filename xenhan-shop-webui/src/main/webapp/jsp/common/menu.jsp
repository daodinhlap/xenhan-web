	...
	<div class="col-sm-3 col-md-2 sidebar">
		...
		<ul class="nav nav-sidebar" style="font-size: 14px;">
			<c:if test="${not empty shopName && !shopName.equals('null') }">
				<li><a href="/"> <img src="/resources/images/icon-home.png"><span>Trang
							chủ</span></a></li>
				<li><a href="/order/tao-don?type=0"> <img
						src="/resources/images/icon-order.png"><span>Tạo đơn
							hàng</span></a></li>
				<li><a href="/order-excel/tao-don-tu-excel"> <img
						src="/resources/images/icon-order-excel.png"><span>Tạo
